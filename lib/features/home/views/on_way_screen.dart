...
class OnWayScreen extends GetView<HomeController> {
  OnWayScreen({super.key});
  @override
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: ClipRRect(
                                    borderRadius: BorderRadius.circular(15.sp),
                                    child: Image.asset("assets/png/home/meter.png", fit: BoxFit.cover,)),
                              ),
                              SizedBox(height: 1.5.h,),
                              customText(
                                  text: "Order Details",
                      ...
                      elevatedContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            buttonWidget("Start Fueling", whiteColor, isGradient: true, fontsize: 15.sp, onTap: (){
                              Get.toNamed("fueling");
                            })
                          ],
                        ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            buttonWidget("Upload Delivery Photo", blueColor, borderColor: blueColor, fontsize: 15.sp, onTap: (){
                              jobDialog(context, progressValue: controller.progressValue, title: "Upload Meter Image", imgPath: "assets/png/home/meter.png",);
                            }),
                            SizedBox(height: 2.5.h,),
                            customText(
